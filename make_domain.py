...
from .utils import factors, polar_stereo, mask_box, mask_above_line, mask_iceshelf_box, real_dir, mask_3d, xy_to_xyz, z_to_xyz, fix_lon_range
...
def add_bear_ridge_bergs (lon, lat, bathy, omask):
    ...
    wall_pts = (lat_2d >= ymin)*(lat_2d <= ymax)*(lon_2d == lon[i_wall])
    bathy[wall_pts] = 0
    omask[wall_pts] = 0

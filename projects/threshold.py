...
def cmip_co2 (fig_dir='./'):
    ...
    timeseries_multi_plot(np.arange(150)+1, [co2_pi, co2_1pct, co2_abrupt], titles, colours, title=r'CO$_2$ concentration', units='ppm', dates=False, fig_name=fig_dir+'co2_cmip.png')

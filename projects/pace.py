...
def plot_sfc_trends (trend_dir='./', grid_dir='PAS_grid/', fig_dir='./'):
    ...
    titles = [r'$\bf{a}$. Surface air temperature', r'$\bf{b}$. Meridional wind', r'$\bf{c}$. Sea ice freezing', r'$\bf{d}$. Sea ice melting', r'$\bf{e}$. Sea ice thickness', r'$\bf{f}$. Surface freshwater flux', r'$\bf{g}$. Sea surface temperature', r'$\bf{h}$. Sea surface salinity']
    ...
    ticks = [np.arange(1.2, 2.2, 0.2), np.arange(-0.2, 0.2, 0.1), np.arange(-2, 0.5, 0.5), np.arange(-0.6, 0.6, 0.3), np.arange(-0.6, 0.2, 0.2), np.arange(0, 3, 1), np.arange(0.2, 0.8, 0.2), np.arange(-0.1, 0.2, 0.1)]

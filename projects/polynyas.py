...
def prelim_latlon (base_dir='./', fig_dir='./'):
    ...
    plot_latlon_5panel('HfC', 'Heat content relative to in-situ freezing point (J), 1979-2016', option='anomaly', zoom_fris=True, vmin=0, vmax=2.5e18, extend='both', vmin_diff=-2e17, vmax_diff=2e17 extend_diff='both')

...
def prelim_latlon (base_dir='./', fig_dir='./'):
    ...
    plot_latlon_5panel('HfC', 'Heat content relative to in-situ freezing point (J), 1979-2016', option='anomaly', zoom_fris=True, vmin=0, vmax=5e18, extend='both', vmin_diff=-5e17, extend_diff='min')

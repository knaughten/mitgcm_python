...
def buttressing_cmap ():

    cm_data = [[0.9884, 0.9923, 0.9375], [0.9920, 0.9946, 0.9120], [0.9950, 0.9967, 0.8850], [0.9974, 0.9983, 0.8578], [0.9991, 0.9994, 0.8318], [0.9999, 1.0000, 0.8082], [1.0000, 1.0000, 0.7878], [1.0000, 1.0000, 0.7692], [1.0000, 1.0000, 0.7517], [1.0000, 1.0000, 0.7346], [1.0000, 1.0000, 0.7173], [1.0000, 1.0000, 0.6991], [1.0000, 1.0000, 0.6794], [1.0000, 1.0000, 0.6575], [1.0000, 1.0000, 0.6328], [1.0000, 1.0000, 0.6047], [1.0000, 1.0000, 0.5656], [1.0000, 1.0000, 0.5065], [1.0000, 1.0000, 0.4330], [1.0000, 1.0000, 0.3508], [1.0000, 1.0000, 0.2658], [1.0000, 1.0000, 0.1836], [1.0000, 1.0000, 0.1102], [1.0000, 1.0000, 0.0513], [1.0000, 1.0000, 0.0126], [1.0000, 1.0000, 0], [1.0000, 0.9954, 0], [1.0000, 0.9838, 0], [1.0000, 0.9666, 0], [1.0000, 0.9449, 0], [1.0000, 0.9200, 0], [1.0000, 0.8934, 0], [1.0000, 0.8661, 0], [1.0000, 0.8396, 0], [1.0000, 0.8151, 0], [1.0000, 0.7937, 0], [1.0000, 0.7732, 0], [1.0000, 0.7528, 0], [1.0000, 0.7323, 0], [1.0000, 0.7118, 0], [1.0000, 0.6913, 0], [1.0000, 0.6709, 0], [1.0000, 0.6504, 0], [1.0000, 0.6299, 0], [1.0000, 0.6094, 0], [1.0000, 0.5892, 0], [1.0000, 0.5699, 0], [1.0000, 0.5514, 0], [1.0000, 0.5331, 0], [1.0000, 0.5148, 0], [1.0000, 0.4959, 0], [1.0000, 0.4760, 0], [1.0000, 0.4547, 0], [1.0000, 0.4316, 0], [1.0000, 0.4062, 0], [1.0000, 0.3780, 0], [1.0000, 0.3464, 0], [1.0000, 0.3118, 0], [1.0000, 0.2742, 0], [1.0000, 0.2340, 0], [1.0000, 0.1913, 0], [1.0000, 0.1463, 0], [1.0000, 0.0993, 0], [1.0000, 0.0504, 0], [1.0000, 0, 0], [1.0000, 0, 0], [0.9545, 0, 0.0455], [0.9091, 0, 0.0909], [0.8636, 0, 0.1364], [0.8182, 0, 0.1818], [0.7727, 0, 0.2273], [0.7273, 0, 0.2727], [0.6818, 0, 0.3182], [0.6364, 0, 0.3636], [0.5909, 0, 0.4091], [0.5455, 0, 0.4545], [0.5000, 0, 0.5000]]
    return cl.LinearSegmentedColormap.from_list('buttressing', cm_data)
...
def set_colours (data, ctype='basic', vmin=None, vmax=None, change_points=None, val0=None):
    ...
    elif ctype == 'buttressing':
        return buttressing_cmap(), vmin, vmax

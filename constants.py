...
region_bounds = {
    ...
    'dotson_front': [-114, -110.5, -74.3, -73.5],
...
region_names = {
    ...
    'filchner_trough_icefront': 'Ice shelf front at Filchner Trough',
    'ronne_depression_icefront': 'Ice shelf front at Ronne Depression'
}

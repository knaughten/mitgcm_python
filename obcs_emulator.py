...
def run_emulator (trend='linear', feedback='none', correction='linear', coeff=1, power=1, prob_new_trend=0, num_time=150):
    ...
    # Now build underlying trend (inner function so we can call it later)
    def build_trend ():
